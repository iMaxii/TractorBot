...
class BanWord(commands.Cog):
    ...
    @commands.hybrid_command(
        name="banword",
        description="Agrega una palabra o frase a la lista de palabras prohibidas",
        aliases=["bw", "banw"],
    )
    ...
    @commands.hybrid_command(
        name="unbanword",
        description="Elimina una palabra o frase de la lista de palabras prohibidas",
        aliases=["unbw", "unbanw"],
    )
    ...
    @commands.hybrid_command(
        name="bannedwords",
        description="Muestra la lista de palabras prohibidas",
        aliases=["bwlist", "bwl"],
    )
    @commands.has_permissions(ban_members=True)
